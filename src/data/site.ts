...
export const programs = [
  { number: '01', slug: 'kishalay', name: 'Poorbita Kishalay', title: 'Children, learning & talent', text: 'Non-formal elementary education, nutrition, emotional care, digital learning, sports and creative development for children facing educational barriers.', focus: ['Foundational learning', 'Nutrition support', 'Sports and talent', 'Arts and culture', 'Basic computer learning'], image: '/images/programs/kishalay-creative-learning.jpg', alt: 'Young children practising letters and drawing in a Poorbita Kishalay class', galleryCount: 48 },
